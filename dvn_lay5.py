...
Original file is located at
    https://colab.research.google.com/drive/1R6zvPIIxxWeelijyowR8YJ0ubRjGSLxj
"""
...
np.savetxt('lay5_soup_final.txt', soup_final)
np.savetxt('lay5_soup_SMA100.txt', soup_SMA100)
...
output_filename = "lay5_potting_onion.txt"
...
# Create a filename for the output
output_filename = "lay5_dish_pickup.txt"
...
plt.title('number of soups at each episode for layout 5')
plt.xlabel('episode')
plt.ylabel('soups')
# plt.ylim(-500, 500)
plt.grid(True)
plt.savefig('p3.layout5.png')
plt.show()
plt.clf()
...
# plt.ylim(-500, 500)
plt.grid(True)
plt.savefig('p3.layout5_test.png')
plt.show()
plt.clf()

np.savetxt('lay5_soup_result_100.txt',  soup_result_100)