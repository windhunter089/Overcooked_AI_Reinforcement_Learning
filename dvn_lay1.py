...
Original file is located at
    https://colab.research.google.com/drive/1RSPWXdnZPQ00du6_leLPKj1C7axgRnWQ
"""
...
np.savetxt('lay1soup_final.txt', soup_final)
np.savetxt('lay1_soup_SMA100.txt', soup_SMA100)
...
output_filename = "lay1_potting_onion.txt"
...
# Create a filename for the output
output_filename = "lay1_dish_pickup.txt"
...
plt.title('number of soups at each episode for layout 1')
plt.xlabel('episode')
plt.ylabel('soups')
# plt.ylim(-500, 500)
plt.grid(True)
# plt.savefig('p3.layout1_test.png')
plt.show()
plt.clf()
...
np.savetxt('lay1_soup_result_100.txt',  soup_result_100)